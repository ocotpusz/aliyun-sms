...
namespace Octopusz\Sms\Core\Profile;

use Octopusz\Sms\Core\Auth\Credential;
use Octopusz\Sms\Core\Auth\ShaHmac1Signer;
use Octopusz\Sms\Core\Regions\ProductDomain;
